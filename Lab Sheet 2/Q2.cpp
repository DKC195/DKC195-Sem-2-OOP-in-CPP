...
int convert(int ft) { return ft * 12; }

int convert(int *ft, int inch) { return *ft * inch; }

int main() {
  int ft, ans;
  cout << "Case 1: " << endl << "Enter Feet: ";
  convert();

  cout << "Case 2: " << endl << "Enter Feet: ";
  cin >> ft;
  cout << ft << " Feet = " << convert(ft) << " Inches" << endl;

  cout << "Case 3: " << endl << "Enter Feet: ";
  cin >> ft;
