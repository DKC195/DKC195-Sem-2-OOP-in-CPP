...
the parameter passed. Display the report in the following format. An employee
with ... ... ... has received Rs ... ... ...as a bonus and had worked ... ...
... hours as overtime in the year ... ... ...*/
#include <iostream>
using namespace std;
...
public:
  ...
  void displayreport() {
    cout << "An employee with ID " << emp_id << " has received Rs " << bonus
         << " as a bonus and had worked " << ot
         << " hours as overtime in the year " << year;
  }
};
